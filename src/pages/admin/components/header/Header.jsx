  ...
  return (
    <header className="flex h-fit w-full items-center justify-between p-4 lg:h-full lg:max-w-[300px] lg:flex-col lg:items-start lg:justify-start lg:p-0">
      ...
      <div className="cursor-pointer lg:hidden">
        {isMenuActive ? (
          <AiOutlineClose className="w-6 h-6" color="white" onClick={toggleMenuHandler} />
        ) : (
          <AiOutlineMenu className="w-6 h-6" color="white" onClick={toggleMenuHandler} />
        )}
...
>
  ...
  <Link 
    ...
    className="flex items-center gap-2 px-4 py-2 text-[15px] font-medium text-gray-700 rounded-md transition"
  >
  ...
  <button
    ...
    className={`button-addpost flex items-center gap-1.5 px-4 py-2 text-[25px] font-medium rounded-md transition w-full text-left
    ${isLoadingCreatePost 
