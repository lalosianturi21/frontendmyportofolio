        ...
        <main className='l-main'>
            <section className='home bd-grid' id="home">
                ...
                <div className="home__social">
                    <a href="https://www.linkedin.com/in/tio-fulalo-simatupang-5b9547210/" target="_blank" className="home__social-icon" data-aos="fade-up"><i className='bx bxl-linkedin'></i></a>
                    <a href="https://scholar.google.com/citations?hl=id&user=dzrOc00AAAAJ" target='_blank' className="home__social-icon" data-aos="fade-up"><i class='bx bx-book'></i></a>
                    <a href="https://github.com/lalosianturi21" target='_blank' className="home__social-icon" data-aos="fade-up" ><i className='bx bxl-github' ></i></a>
                </div>
